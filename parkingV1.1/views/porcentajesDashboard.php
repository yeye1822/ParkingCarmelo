  ...
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 ">
  	<div class='contDos'>
  		<h1><?php echo round(($salidaInusual[0]*100)/$totalInusual[0],0,PHP_ROUND_HALF_UP).'%'; ?></h1>
  ...
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
  	<div class='contTres'>
  		<h1><?php echo round((($totalInusual[0]-$salidaInusual[0])*100)/$totalInusual[0],0,PHP_ROUND_HALF_UP).'%'; ?></h1>
